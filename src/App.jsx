...
/* ============================================================
   ...
   Embedded below at half scale (49px frames). PC build: save
   cb-team-actions-atlas-v2-transparent.png to /public/sprites/ and
   double the frame/sheet numbers.
   ============================================================ */
const CB_ACTION_SPRITE_SHEET = "data:image/png;base64,";
...
function TeamActionSprite({ teamId, card, action, frame = 0, size = 1, animate = false, className = "", style = {} }) {
...
function FieldSprite({ team, action = "run", animate = false, frameIdx = 0, facing = 1, flat = false, style = {}, dur = 0.5, size = 0.8 }) {
  const w = CB_ACTION_ATLAS.frameW * 1.42 * size, h = CB_ACTION_ATLAS.frameH * 1.42 * size;
  return (
    <div style={{ position: "absolute", width: w, height: h, transition: `left ${dur}s cubic-bezier(.3,.9,.4,1), top .35s ease`, ...style }}>
      ...
      <div style={{ transform: `scaleX(${facing}) ${flat ? "rotate(90deg)" : ""}`, transition: "transform .25s ease", width: w, height: h }}>
        <TeamActionSprite teamId={team} action={action} frame={frameIdx} animate={animate} size={size}
          style={{ filter: "contrast(1.08) saturate(1.1) drop-shadow(0 3px 4px #00000088)" }} />
      </div>
    </div>
  );
}
    ...
    <div style={{ margin: "8px 0 12px" }}>
      <div className={shake ? "cb-shake" : ""} style={{ position: "relative", height: 170, borderRadius: 10, border: "3px solid #1B1B1B", overflow: "hidden", imageRendering: "pixelated", background: "#249039" }}>
        ...
        <FieldSprite team={defId} facing={-1} dur={runDur} action="run"
          animate={!!(moving && st >= 1)} frameIdx={frame % 3 === 0 ? 2 : 0}
        ...
        <FieldSprite team={defId} facing={-1} dur={runDur}
          ...
          style={{ left: `calc(${dbPct}% - 26px)`, top: 94 }} />
        ...
        <FieldSprite team={possession} facing={T === "int" && st >= 2 ? -1 : 1} dur={runDur}
          ...
          frameIdx={0}
          style={{ left: `calc(${carrierPct ?? losPct}% - 26px)`, top: T === "td" && st >= 2 ? 40 : 88 }} />
